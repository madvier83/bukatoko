...
@section('content')
<div class="flex flex-col md:flex-row justify-between items-end px-8 lg:px-36 mt-12 md:mt-24 md:mb-16 lg:mb-20">
...
<div class="relative">
    ...
    <div class="flex overflow-hidden px-8 lg:px-36 overflow-y-hidden gap-2 box-scroll">
        ...
        <div class="absolute z-10 w-72 h-full -right-0 bg-gradient-to-l from-zinc-900 to-transparent">
        </div>
        ...
        <a href="/products/{{ $item->id }}">
            <div
                ...
                <div
                    class="flex items-center justify-center overflow-hidden bg-zinc-700 object-contain rounded-t-lg opacity-75">
                    <div class="h-64 w-64 flex">
                        <img class="object-cover scale-110 group-hover:scale-100 duration-500 mx-auto rounded-lg"
...
<div class="divider mt-16 lg:px-16"></div>

<div class="px-8 lg:px-36 mt-16 pb-64">
...
<script>
    ...
    mouseWheel.addEventListener('wheel', function(e) {
        const race = 70; // How many pixels to scroll
